// Scripting Engine for Melvor Idle v0.2.2.2 by aldousWatts on GitLab | Built for Melvor Idle alpha v0.12.2
...
clnheading.childNodes[0].textContent = " SEMI v0.2.2.2";
