(() => {
    ...
    const injectUtils = () => {
        ...
        const equipSwap = (idSwap, slotName) => {
            ...
            if (!equipSwapConfig[slotName].swapped) {
                ...
                if (slotName === 'Weapon') {
                    ...
                    if (
                        items[currentlyEquippedItemID].ammoType === 2 ||
                        items[currentlyEquippedItemID].ammoType === 3
                    ) {
        ...
        const adjustedMaxHit = () => {
            ...
            const stunnedCase =
                playerIsStunned && !isNaN(SEMI.incomingAttackData().incomingAttack.stunDamageMultiplier);
            if (stunnedCase) {
