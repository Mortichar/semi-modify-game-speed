var autoSellShow = (() => {
    ...
    const el = (i) => {
        ...
        const e = $(`<img id="auto-${pluginKind}-img-${i}" class="skill-icon-sm js-tooltip-enable" src="${media}" data-toggle="tooltip" data-html="true" data-placement="bottom" title="" data-original-title="${name}">`);
