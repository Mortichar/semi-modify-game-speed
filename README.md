## This is Scripting Engine for Melvor Idle v0.1.
...
This add-on/extension helps you automate certain aspects of the game, and adds certain useful features, combining many scripts into one with the ability to toggle on and off in-game.
